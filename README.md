...
## 🛠️ Skills
<p align="start">
  <img src="https://skillicons.dev/icons?i=aiscript,anaconda,androidstudio,angular,aws,azure,bash,blender,bootstrap,c,cs,cpp,cloudflare,cmake,css,bots,django,docker,dotnet,eclipse,electron,express,fastapi,figma,firebase,flask,flutter,gcp,git,github,githubactions,gitlab,go,gradle,graphql,heroku,html,htmx,ai,java,js,jenkins,jquery,kubernetes,laravel,latex,linux,matlab,mongodb,mysql,nestjs,nextjs,nginx,nodejs,nuxtjs,opencv,php,postgres,postman,powershell,pycharm,py,pytorch,qt,react,raspberrypi,redhat,redis,redux,regex,remix,ruby,rust,sass,spring,sqlite,stackoverflow,sublime,supabase,sklearn,selenium,solidity,svg,swift,tailwind,tensorflow,terraform,threejs,ts,ubuntu,unity,unreal,vercel,visualstudio,vite,vscode,vue,wasm,webflow,windows,wordpress" />
</p>
